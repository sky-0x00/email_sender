...
//#define USE_EXRERNAL_STYLE
	...
	#define EMAIL_MESSAGE						LR"(<!DOCTYPE HTML><html><head><title>)" EMAIL_TOPIC LR"(</title><meta charset="utf-8"><style type="text/css"></style></head><body><div class="center-block"><a href="https://cryp.trade/agent/)" EMALE_MESSAGE__CRYP_TRADE__AGENT_ID LR"STR("><div class="top" style="background-color: rgba(162, 210, 252, 0.7)"><img src=")STR" EXTERNAL_WEB_STORAGE LR"(logo_full.png"/></div></a><div class="content"><div class="message"><p>Вы уже слышали про криптовалюту или имеете четкое представление о ней? Впечатлены успехом биткоина? Или просто ищете дополнительный источник дохода? Предлагаю не пройти мимо и познакомиться с темой поближе.</p><p>В настоящее время я ищу соинвесторов для совместного заработка в одной из доходных компаний. Только реальные инвестиции и только реальный доход! Поделюсь своей стратегией, покажу что и как и, конечно, покажу свои выплаты.</p><p>Приходите в мою <a href="https://vk.com/)" EMALE_MESSAGE__VK_GROUP_ID LR"(">группу В-Контакте</a> и задавайте вопросы.</p></div><div class="contacts"><p>С уважением, <a href="https://vk.com/)" EMALE_MESSAGE__VK__ACCOUNT_ID LR"(">)" EMAIL_FROM_NAME LR"(</a></p><p>e-mail: <a href="mailto:)" EMAIL_ADDRESS_FROM LR"(?subject=)" EMAIL_TOPIC LR"(">)" EMAIL_ADDRESS_FROM LR"(</a></p></div><div class="unsibscribe"><p>Ваша персональная ссылка для подписки на данную рассылку: <span>)" GUID_NULL__STRING LR"(</span></p></div></div><a href="https://cryp.trade/agent/)" EMALE_MESSAGE__CRYP_TRADE__AGENT_ID LR"STR("><div class="bottom" style="background-color: rgba(162, 210, 252, 0.7)"><div class="right"><p class="link">https://cryp.trade</p><p class="info">CRYP TRADE CAPITAL HOLDING</p></div><img style="height: 64px;" src=")STR" EXTERNAL_WEB_STORAGE LR"(link.png"/></div></a></div></body></html>)"
#endif
